...
use Illuminate\Contracts\Session\Session;
 ...
 echo $__env->yieldContent('title'); ?> | Sistem Kepegawaian</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    <header class="app-header"><a class="app-header__logo" href="index.html">Kelompok5</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?php echo e(asset('img/pegawai.png')); ?>" width="50px" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Kelompok5</p>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview <?php echo e(request()->is('agama','negara','darah','keluarga') ? 'is-expanded' : ''); ?>">
          ...
          <ul class="treeview-menu">
            <li><a class="treeview-item <?php echo e(request()->is('agama') ? 'active' : ''); ?>" href="<?php echo e(route('agama.index')); ?>"><i class="icon fa fa-circle-o"></i> Agama</a></li>
            <li><a class="treeview-item <?php echo e(request()->is('negara') ? 'active' : ''); ?>" href="<?php echo e(route('negara.index')); ?>"><i class="icon fa fa-circle-o"></i> Kewarganegaraan</a></li>
            <li><a class="treeview-item <?php echo e(request()->is('darah') ? 'active' : ''); ?>" href="<?php echo e(route('darah.index')); ?>"><i class="icon fa fa-circle-o"></i> Golongan Darah</a></li>
            <li><a class="treeview-item <?php echo e(request()->is('keluarga') ? 'active' : ''); ?>" href="<?php echo e(route('keluarga.index')); ?>"><i class="icon fa fa-circle-o"></i> Keluarga</a></li>
          </ul>
        </li>
        <li class="treeview <?php echo e(request()->is('pegawai','pegawai/*') ? 'is-expanded' : ''); ?>">
          ...
          <ul class="treeview-menu">
            <li><a class="treeview-item <?php echo e(request()->is('pegawai') ? 'active' : ''); ?>" href="<?php echo e(route('pegawai.index')); ?>"><i class="icon fa fa-circle-o"></i> Data Pegawai</a></li>
            <li><a class="treeview-item <?php echo e(request()->is('pegawai/create') ? 'active' : ''); ?>" href="<?php echo e(route('pegawai.create')); ?>" target="" rel="noopener"><i class="icon fa fa-circle-o"></i> Tambah Pegawai</a></li>
          </ul>
        </li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Rekap Data</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo e(route('pegawai-pdf')); ?>"><i class="icon fa fa-circle-o"></i> Pegawai</a></li>
          </ul>
        </li>
      </ul>
    </aside>
...
</html><?php /**PATH C:\Simpeg-Laravel-9-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>