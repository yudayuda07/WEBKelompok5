...
<html>
  <head>
    ...
    <title>Login - Kelompok 5 WEB </title>
  </head>
  <body>
      ...
      <div class="login-box">
        ...
        <?php echo e(csrf_field()); ?>
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="login" type="text" name="login" placeholder="Username" value="<?php echo e(old('login')); ?>" required autofocus>
...
</html><?php /**PATH C:\Simpeg-Laravel-9-main\resources\views/auth/login.blade.php ENDPATH**/ ?>