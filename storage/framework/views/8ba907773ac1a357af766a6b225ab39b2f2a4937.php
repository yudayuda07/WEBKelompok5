        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form class="form-horizontal" action="<?php echo e(route('agama.update', $agama->id_agm)); ?>" method="post">
                <?php echo e(csrf_field()); ?> 
                <?php echo e(method_field('PUT')); ?> 
                <div class="form-group row">
                  <label class="control-label col-md-3">Nama Agama</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" value="<?php echo e($agama->nmagama); ?>" name="nmagama">
                  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kelompok5\resources\views/agama/edit.blade.php ENDPATH**/ ?>